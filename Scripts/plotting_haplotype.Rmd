...
breaks <- c(0,0.2, 5, 14, Inf)  # Adjust these values as needed
labels <- c("Spat", "Recruit", "Juvenile", "Adult")  # Category labels
...
combined_plot <- grid.arrange(p1_label, p2_label, p3_label, ncol = 3)


# Save the combined plot
ggsave("Output/Poc_RA_LifeStage_SiteMap.pdf", plot = combined_plot, width = 20, height = 6)
ggsave("Output/Poc_RA_LifeStage_SiteMap.jpg", plot = combined_plot, width = 20, height = 6)
