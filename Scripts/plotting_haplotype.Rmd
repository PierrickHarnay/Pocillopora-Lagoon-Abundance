...
# Make sure your species color vector is named:
# cols.species <- c("Species1"="#1f77b4", "Species2"="#ff7f0e", ...)

# Add color column to species_scores
species_scores$color <- cols.species[species_scores$Species]

###########
ggplot() +
  geom_point(data = pca_scores, aes(x = PC1, y = PC2, color = Site), size = 3) +
  geom_text(data = species_scores, aes(x = PC1, y = PC2, label = Species), color = "black", alpha = 0.7) +
  theme_minimal() +
  labs(title = "PCA of Sites by Species", x = "PC1", y = "PC2")

ggplot() +
  # Sites as points with different shapes
  ...
  geom_segment(data = species_scores,
               aes(x = 0, y = 0, xend = PC1, yend = PC2, color = cols.species),
               arrow = arrow(length = unit(0.3, "cm")), alpha = 0.8) +
  
  # Optionally, label species at arrow tips
  geom_text(data = species_scores, 
            aes(x = PC1*1.1, y = PC2*1.1, label = Species, color = cols.species),
            size = 3, hjust = 0.5, vjust = 0.5) +
  
  # Use your species color panel
  scale_color_manual(values = cols.species) +
  
  theme_minimal() +
  labs(title = "PCA of Sites by Species",
       x = "PC1", y = "PC2") +
